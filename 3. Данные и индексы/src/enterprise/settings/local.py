...
SECRET_KEY = 'django-insecure-#=a&e*+_qz_6nt3*o_y2x!y-czc1y+frm(+g%tw+d2-6sv7_4a'
...
ROOT_URLCONF = 'enterprise.settings.urls'
...
WSGI_APPLICATION = 'enterprise.settings.wsgi.application'
